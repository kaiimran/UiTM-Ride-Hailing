  ...
  <body>
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="stud_updateacc.php">Update Account <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
    ...
    ?>
      ...
      <div id="input-area">
        ...
        <br>
        <div class="f-inp">
          <input type="text" placeholder="Matrix Number" name="matrix">
        </div>
        <br>
        <div class="f-inp">
      ...
      <div id="submit-button-cvr">
        <button type="submit" name="btnedit" id="submit-button">EDIT</button>
      </div>
      <div id="submit-button-cvr">
        <button type="submit" name="btndelete" id="submit-button" style="background-color: red">DELETE</button>
      </div>
      <br>
