  ...
  <body>
    ...
    <main role="main">
      <div class="container">
        ...
        <center><h1>Bookings That Are Looking For Drivers<h1></center><br>
          <div class="row">
        <!-- Example row of columns -->
          ...
          <div class="col-md-4" style="border: 2px solid #e3e3e3;border-radius: 20px; margin: 2px;">
            ...
            <h5><br>Name: <?php echo $row->student_name ?><br>Pick-up: <?php echo $row->booking_pickup ?>
              <br>Drop-off: <?php echo $row->booking_drop ?><br>Date: <?php echo $row->booking_date ?><br>Time: <?php echo $row->booking_time ?><br><br></h5>
